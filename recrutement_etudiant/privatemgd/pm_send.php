...
$result= mysql_query("SELECT id_etud, login_etud FROM etudiant");
$option="";
...
<body>
    ...
    <?php require_once "pm_check.php"; ?> <br>
    <div class="msg z-depth-2">
       
    <form action="pm_send_to.php" name="form" method="post" onSubmit="return (VerificationDestinataire(this));">
