...
<body>
  <?php include("menuu.php"); ?>
   <div class="box">
    <a href ="pm_inbox_etu.php" class="waves-effect #37474f blue-grey darken-3 btn bt"> Messages Reçus
    <?php 
...
<a href="pm_outbox_etu.php" class="waves-effect #37474f blue-grey darken-3 btn bt"> Messages Envoyés
<?php
    print $outboxMessages;
    ?></a> 
    <a href="pm_send_etu.php" class="waves-effect #37474f blue-grey darken-3 btn bt">Nouveau Message</a>
