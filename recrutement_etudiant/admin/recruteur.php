...
$table=mysql_query("select * from recruteur where valide='0'")or die (mysql_error());
...
?>
 ...
 <html>
    <head>
     <title>Recruteur non validé Admin</title>
...
<body>
     ...
     <table class="responsive-table">
        ...
        <thead>
        <tr>
            <th data-fieled="nom">Nom Société</th>
            <th data-fieled="adresse">Adresse</th>
            <th data-fieled="nom_representant">Nom du Représentant</th>
            <th data-fieled="fonction">Fonction</th>
            <th data-fieled="telr">Telephone</th>
       ...
       <tbody>
            ...
            <td> <a href="info_pay2.php?id=<?php echo $b['id_rec'] ?>">voir</a> </td>
            ...
            <td><a href="sup_rec.php?id=<?php echo $b['id_rec']?>"><button type="submit" class="btn"  onclick="if(window.confirm('voulez vous vraiment le supprimer?')){return true;}else{return false;}"  name="action">Supprimer</button></a></td>
              <td> <a href="valider.php?id=<?php echo $b['id_rec'] ?>" class="btn">Valider</a> </td>
        </tr>
        </tbody>
        <?php } ?>
    </table>
